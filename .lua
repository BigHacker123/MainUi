...
do
    ...
    function library:notification(message, duration, color)
        ...
        function notification:set_message(message)
            ...
            self.objects.background.Size = udim2_new(0, self.objects.label.TextBounds.X + 27, 0, 17)
        end
        ...
        delay(0.5 + duration + 0.15, function()
            notification:remove()
        end)
...
do
    ...
    library:define('menu', function(meta, properties)
        ...
        menu.accent    = properties.accent or Color3.fromRGB(77, 160, 255)
        menu.DiscordInviteID = properties.DiscordInviteID or "6GKghXsW"
        menu.open      = true
        menu.visvalues = {}
        menu.objects   = {}
        menu.tabs      = {}

        library.theme.Accent = menu.accent
...
function library:create_settings_tab(menu)
    ...
    settings_main:keybind({text = 'open / close', flag = 'menubind', default = Enum.KeyCode.LeftAlt, callback = function(bool)
